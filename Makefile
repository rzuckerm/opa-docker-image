OPA_VERSION := $(shell cat OPA_VERSION)
OPA_DEPS := $(wildcard OPA_*) $(wildcard *_opa)
DOCKER_TAG_PREFIX := rzuckerm/opa:$(OPA_VERSION)
...
$(META_BUILD_TARGET): Dockerfile Makefile $(OPA_DEPS)
